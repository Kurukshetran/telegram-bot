...
[source, properties]
----
include::./telegram-bot-springboot/src/main/resources/application.properties[]
----
...
* Simple send your location to the bot (in groups this only works in private mode for bots)
